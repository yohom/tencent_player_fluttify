...
class com_tencent_rtmp_TXLog extends java_lang_Object  {
  static final Finalizer<com_tencent_rtmp_TXLog> _finalizer = Finalizer((__this__) {
    __this__.release__();
  });
  ...
  static Future<com_tencent_rtmp_TXLog> create__() async {
    ...
    final __object__ = TencentPlayerFluttifyAndroidAs<com_tencent_rtmp_TXLog>(__result__)!;
