...
class com_tencent_rtmp_TXImageSprite extends java_lang_Object  {
  static final Finalizer<com_tencent_rtmp_TXImageSprite> _finalizer = Finalizer((__this__) {
    __this__.release__();
  });
  ...
  static Future<com_tencent_rtmp_TXImageSprite> create__android_content_Context(android_content_Context? context) async {
    ...
    final __object__ = TencentPlayerFluttifyAndroidAs<com_tencent_rtmp_TXImageSprite>(__result__)!;
