...
class com_tencent_rtmp_TXLivePlayConfig extends java_lang_Object  {
  static final Finalizer<com_tencent_rtmp_TXLivePlayConfig> _finalizer = Finalizer((__this__) {
    __this__.release__();
  });
  ...
  static Future<com_tencent_rtmp_TXLivePlayConfig> create__() async {
    ...
    final __object__ = TencentPlayerFluttifyAndroidAs<com_tencent_rtmp_TXLivePlayConfig>(__result__)!;
