...
class com_tencent_rtmp_TXLivePlayer_TXLiteAVTexture extends java_lang_Object  {
  static final Finalizer<com_tencent_rtmp_TXLivePlayer_TXLiteAVTexture> _finalizer = Finalizer((__this__) {
    __this__.release__();
  });
  ...
  static Future<com_tencent_rtmp_TXLivePlayer_TXLiteAVTexture> create__() async {
    ...
    final __object__ = TencentPlayerFluttifyAndroidAs<com_tencent_rtmp_TXLivePlayer_TXLiteAVTexture>(__result__)!;
