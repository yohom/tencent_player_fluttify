...
Future<bool> TencentPlayerFluttifyAndroidIs<T>(dynamic __this__) async {
  ...
  if (RegExp(r'^(List<)?(String|int|double)(>)?|(Map<String,(String|int|double)>)$').hasMatch(typeName)) {
    ...
    return result;
  } else if (T == com_tencent_tmediacodec_hook_THookTextureView) {
    final result = await kTencentPlayerFluttifyChannel.invokeMethod('RefClass::isKindOfcom_tencent_tmediacodec_hook_THookTextureView', {'__this__': __this__});
    return result;
  }
  else {
    return false;
...
T? TencentPlayerFluttifyAndroidAs<T>(dynamic __this__) {
  ...
  if (__this__ == null) {
    ...
    return (com_tencent_tmediacodec_hook_THookTextureView()..refId = (__this__ as Ref).refId) as T;
  }
