...
- (NSDictionary<NSString*, Handler>*) getSubHandler2 {
    ...
    return @{
        @"TXVodPlayConfig::set_mediaType": ^(NSObject <FlutterPluginRegistrar> * registrar, id args, FlutterResult methodResult) {
            // print log
            if (enableLog) {
                NSLog(@"TXVodPlayConfig::set_mediaType");
            }
        
            // args
            // enum arg
            TX_Enum_MediaType mediaType = (TX_Enum_MediaType) [args[@"mediaType"] integerValue];
        ...
        @"TXVodPlayer::set_delegate": ^(NSObject <FlutterPluginRegistrar> * registrar, id args, FlutterResult methodResult) {
            ...
            // args
            // ref arg
            id<TXLivePlayListener> delegate = (id<TXLivePlayListener>) (args[@"delegate"] == [NSNull null] ? nil : args[@"delegate"]);
        ...
        @"TXLivePlayer::set_recordDelegate": ^(NSObject <FlutterPluginRegistrar> * registrar, id args, FlutterResult methodResult) {
            ...
            // args
            // ref arg
            id<TXLiveRecordListener> recordDelegate = (id<TXLiveRecordListener>) (args[@"recordDelegate"] == [NSNull null] ? nil : args[@"recordDelegate"]);
            ...
            ref.recordDelegate = recordDelegate;
            methodResult(@"success");
        },
        ...
        @"TXVodDownloadDataSource::set_overlayKey_batch": ^(NSObject <FlutterPluginRegistrar> * registrar, id argsBatch, FlutterResult methodResult) {
            for (NSUInteger __i__ = 0; __i__ < ((NSArray<NSDictionary<NSString*, NSObject*>*>*) argsBatch).count; __i__++) {
                NSDictionary<NSString*, id>* args = [((NSArray<NSDictionary<NSString*, id>*>*) argsBatch) objectAtIndex:__i__];
        ...
        @"TXVodDownloadDataSource::set_overlayIv_batch": ^(NSObject <FlutterPluginRegistrar> * registrar, id argsBatch, FlutterResult methodResult) {
            for (NSUInteger __i__ = 0; __i__ < ((NSArray<NSDictionary<NSString*, NSObject*>*>*) argsBatch).count; __i__++) {
                NSDictionary<NSString*, id>* args = [((NSArray<NSDictionary<NSString*, id>*>*) argsBatch) objectAtIndex:__i__];
        ...
        @"TXVodPlayConfig::set_mediaType_batch": ^(NSObject <FlutterPluginRegistrar> * registrar, id argsBatch, FlutterResult methodResult) {
            for (NSUInteger __i__ = 0; __i__ < ((NSArray<NSDictionary<NSString*, NSObject*>*>*) argsBatch).count; __i__++) {
                NSDictionary<NSString*, id>* args = [((NSArray<NSDictionary<NSString*, id>*>*) argsBatch) objectAtIndex:__i__];
        ...
        @"TXLiveBaseDelegate::createAnonymous__": ^(NSObject <FlutterPluginRegistrar> * registrar, id args, FlutterResult methodResult) {
            id<TXLiveBaseDelegate> __result__ = [[TXLiveBaseDelegate_Anonymous alloc] initWithFlutterPluginRegistrar:registrar];
            methodResult(__result__);
        },
        @"TXLiveRecordListener::createAnonymous__": ^(NSObject <FlutterPluginRegistrar> * registrar, id args, FlutterResult methodResult) {
            id<TXLiveRecordListener> __result__ = [[TXLiveRecordListener_Anonymous alloc] initWithFlutterPluginRegistrar:registrar];
            methodResult(__result__);
        },
        ...
        @"TXLivePlayListener::createAnonymous__": ^(NSObject <FlutterPluginRegistrar> * registrar, id args, FlutterResult methodResult) {
            id<TXLivePlayListener> __result__ = [[TXLivePlayListener_Anonymous alloc] initWithFlutterPluginRegistrar:registrar];
            methodResult(__result__);
        },
